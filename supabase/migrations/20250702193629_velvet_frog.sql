/*
  ...
  1. New Tables
    - `teams`
      ...
      - `leader_user_profile_id` (uuid, required) - Reference to team leader
      - `max_members` (integer, default 4) - Maximum team size (1-6)
  ...
  3. Security
    ...
    - Add triggers for team size validation and leadership management

  4. Performance
    - Add indexes for efficient queries
    - Create view for team details with member information
*/
...
DROP TRIGGER IF EXISTS enforce_team_size_limit ON user_profiles;
...
DROP TRIGGER IF EXISTS set_leader_team_id_trigger ON teams;
...
DROP TRIGGER IF EXISTS handle_leader_departure_trigger ON user_profiles;
...
DROP VIEW IF EXISTS team_details;
